				...
				<div class="row">
					<div class="col-lg-12">
						<div class="logo pull-left">
							<h2><strong><a href="index.php">Waga Online Bookstore</a></strong></h2>
						</div>
	                ...
	                <div class="error"></div>
						...
						<h2>Register</h2>
						  <form action="#" method="post" id="register-form">
					            ...
					            <!-- json response will be here -->
								<div class="form-group">
										<input type="text" id="full_name" name="full_name" placeholder="First Name" class="form-control br-radius-zero" />
										<span class="help-block" id="error"></span>
								</div>
								<div class="form-group">
										<input type="text" id="last_name" name="last_name" placeholder="Last Name" class="form-control br-radius-zero" />
										<span class="help-block" id="error"></span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
										<input type="text" id="reg_email" name="reg_email" placeholder="Email" class="form-control br-radius-zero" />
										<span class="help-block" id="error"></span>
								</div>
								<div class="form-group">
										<input type="password" id="reg_password" name="reg_password" placeholder="Password" class="form-control br-radius-zero" />
										<span class="help-block" id="error"></span>
								</div>
								<div class="form-group">
